...
export default function FicheTC() {
  const handlePrint = () => {
    window.print();
  };
    ...
    <div className="w-full max-w-3xl mx-auto my-4 sm:my-8 p-4 sm:p-6 bg-white shadow-md sm:rounded-lg border border-gray-200">
      ...
      <div className="text-center border-b pb-4 mb-6">
        ...
        <p className="text-gray-700 font-medium text-xs sm:text-sm mt-1">
          Fiche de Renseignement — 1ère Année TC
        </p>
        <p className="text-gray-500 text-xs">
          Infirmier d'État / Sage-Femme d'État (Niveau BAC — 3 ans)
        </p>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="bg-gray-50 p-3 rounded border">
            ...
            <ul className="list-disc list-inside text-xs sm:text-sm text-gray-700 mt-1 space-y-0.5">
              <li>Trousseau Pédagogique - Kit Basic (22 500 F)</li>
        ...
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded text-xs sm:text-sm text-blue-950 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1">
          ...
          <span className="text-base sm:text-lg font-bold">190 500 F CFA</span>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm text-gray-700">
          <li className="flex items-start sm:items-center bg-gray-50 p-2 rounded col-span-1 sm:col-span-2 border-l-2 border-red-500">
            <span className="w-1.5 h-1.5 bg-red-500 rounded-full mr-2 mt-1.5 sm:mt-0 shrink-0"></span>
            <span>
        ...
        <div className="mt-3 bg-amber-50 p-3 rounded border border-amber-200 text-amber-900 text-xs sm:text-sm sm:flex-col items-start">
          <span className="mr-2 my-4 font-bold shrink-0">
            📚 Obligation Matérielle :
          </span>
          <div>
            Chaque étudiant doit obligatoirement fournir{" "}
            <strong>01 Rame de papier pour chaque année</strong>.
          </div>
        </div>
      </div>
