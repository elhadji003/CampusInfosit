...
export default function FicheAIE2() {
  const handlePrint = () => {
    window.print();
  };
  ...
  return (
    <div className="w-full max-w-3xl mx-auto my-4 sm:my-8 p-4 sm:p-6 bg-white shadow-md sm:rounded-lg border border-gray-200">
      {/* Bouton Impression (Masqué à l'impression papier) */}
      <div className="flex justify-end mb-4 print:hidden">
        <button
          onClick={handlePrint}
          className="flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition shadow-sm"
        >
          <Printer size={16} />
      ...
      <div className="text-center border-b pb-4 mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-teal-700 uppercase tracking-wide">
          INFOSITS — Thiès
        </h1>
        ...
        <p className="text-gray-500 text-xs">
          Assistant Infirmier d'État (Niveau Troisième — 02 ans)
        </p>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="bg-gray-50 p-3 rounded border">
            ...
            <ul className="list-disc list-inside text-xs sm:text-sm text-gray-700 mt-1 space-y-0.5">
              ...
              <li>
                Blouse École et de stage :{" "}
                <span className="font-semibold">11 000 F CFA</span>
              </li>
              <li>
                Carnet, F.T, Portfolio &amp; Reliure :{" "}
                <span className="font-semibold">10 000 F CFA</span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-4 p-3 bg-teal-50 border border-teal-200 rounded text-xs sm:text-sm text-teal-950 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1">
          <span className="font-semibold">
            Total à verser à la Ré-inscription (avec Scolarité Nov. et Août) :
          </span>
          <span className="text-base sm:text-lg font-bold text-teal-800">
            150 000 F CFA
          </span>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm text-gray-700">
          ...
          <li className="flex items-center bg-gray-50 p-2 rounded">
            <span className="w-1.5 h-1.5 bg-teal-500 rounded-full mr-2 shrink-0"></span>
            Dernier bulletin de 3ème ou Certificat de scolarité
          </li>
          <li className="flex items-center bg-gray-50 p-2 rounded">
            <span className="w-1.5 h-1.5 bg-teal-500 rounded-full mr-2 shrink-0"></span>
        ...
        <div className="mt-3 bg-amber-50 p-3 rounded border border-amber-200 text-amber-900 text-xs sm:text-sm flex-col flex items-start">
          ...
          <div>
            Chaque étudiant(e) inscrit(e) doit obligatoirement fournir{" "}
      ...
      <div className="p-3 sm:p-4 bg-red-50 border-l-4 border-red-500 text-red-900 rounded-r-md">
        <h4 className="font-bold text-xs sm:text-sm flex items-center mb-1">
          🛑 NB : Clause de non-remboursement &amp; Diplôme
        </h4>
        <p className="text-xs sm:text-sm mb-2">
          Le Diplôme d'État d'Assistant Infirmier n'est délivré qu'après la
          réussite complète du cursus de 02 ans et de l'Examen de Certification.
        </p>
